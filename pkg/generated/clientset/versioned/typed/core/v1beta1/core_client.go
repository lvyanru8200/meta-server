...
type CoreV1beta1Interface interface {
	...
	HyperparametersGetter
	LLMsGetter
}

// CoreV1beta1Client is used to interact with features provided by the core.datatunerx.io group.
type CoreV1beta1Client struct {
	restClient rest.Interface
}

func (c *CoreV1beta1Client) Hyperparameters(namespace string) HyperparameterInterface {
	return newHyperparameters(c, namespace)
}

func (c *CoreV1beta1Client) LLMs(namespace string) LLMInterface {
	return newLLMs(c, namespace)
}
